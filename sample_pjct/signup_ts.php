	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">Trainee Sign Up</div>
				<div class="panel-body">
					<form role="form" method="POST" action="">
						<fieldset>
							...
							<div class="form-group">
								<input id="searchTextField" class="form-control" placeholder="Location" name="location" type="text" autofocus="">
							</div>
							<div class="form-group">
...
if(!empty($_POST['user']) && !empty($_POST['pass']) && !empty($_POST['email']) && !empty($_POST['location'])) {  
	session_start();
    $user=$_POST['user'];  
    $pass=$_POST['pass']; 
    $email=$_POST['email'];
    ...
    $query=mysqli_query($con,"SELECT MAX(Trainee_ID) AS MAXID FROM Trainee");    
    $row=mysqli_fetch_assoc($query);
    $nid=$row['MAXID'];
    $nnid=$nid+1;
    $query1=mysqli_query($con,"INSERT INTO Trainee VALUES('".$nnid."','".$user."','".$location."','".$email."','".$pass."','0')");
    header("Location: ./login_ts.php");  
