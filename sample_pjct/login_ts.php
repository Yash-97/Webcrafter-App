	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">Trainee Log in</div>
				<div class="panel-body">
					<form role="form" method="POST" action="">
						<fieldset>
							...
							<a class="txt2" href="./signup_ts.php">
							Create your Account
...
if(!empty($_POST['user']) && !empty($_POST['pass'])) {
    ...
    $query=mysqli_query($con,"SELECT * FROM Trainee WHERE Email='".$user."' AND Password='".$pass."'");  
    ...
    //$ip=$_SESSION['ip2']; 
    $_SESSION['sess_tid']=$tid;
    $_SESSION['trainee_loggedin']=true;
    //$_SESSION['user']=$user;
	...
	$ip=get_client_ip();
	//$query1=mysqli_query($con,"UPDATE Trainee SET IP_Address = '".$ip."' WHERE Email = '".$user."'");
	//$query2=mysqli_query($con,"INSERT INTO Orders VALUES('".$custid."".rand(100,99999)."','".$custid."','".$_SESSION['selected_seller']."','F')");
    /* Redirect browser */  
    //header("Location: ../Data/data.php");
    $_SESSION['logged_trainee']=$user;
    header("Location: dashboard_ts.php");
    }  
    } else {  
