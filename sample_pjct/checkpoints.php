...
if(isset($_SESSION['trainee_loggedin']) && $_SESSION['trainee_loggedin']==true)
    {
		...
		<ul class='nav menu'>
			...
			<li><a href='tutorials.php'><svg class='glyph stroked calendar'><use xlink:href='#stroked-calendar'></use></svg> Tutorials</a></li>
			<li class='active'><a href='checkpoints.php'><svg class='glyph stroked line-graph'><use xlink:href='#stroked-line-graph'></use></svg> Checkpoints</a></li>
...
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Checkpoints</h1>
			</div>
		</div><!--/.row-->
	...
	while($row=mysqli_fetch_assoc($query))
    {
        ...
        echo "<div class='col-xs-12 col-md-6 col-lg-3 cards' style='margin-right:20px; margin-bottom:20px;'>
				...
				<div class='container1'>
					<h4><b><i class='fa fa-check-circle' style='color: green' aria-hidden='true'></i></b> &nbsp;Get tools from us</h4> 
					<br>
					<h4><b><i class='fa fa-check-circle' style='color: green' aria-hidden='true'></i></b> &nbsp;Travel and complete assignments</h4> 
					<br>				
				</div>
			</div>";
		}
			...
			echo "<div class='col-xs-12 col-md-6 col-lg-3 cards' style='margin-right:20px; margin-bottom:20px;'>
				...
				<div class='container1'>
					<h4><b><i class='fa fa-times-circle' style='color: red' aria-hidden='true'></i></b> &nbsp;Get tools from us</h4> 
					<br>
					<h4><b><i class='fa fa-times-circle' style='color: red' aria-hidden='true'></i></b> &nbsp;Travel and complete assignments</h4> 
					<br>				
				</div>
			</div>";
		}
