...
if(isset($_SESSION['trainee_loggedin']) && $_SESSION['trainee_loggedin']==true)
    {
        	echo"
		<ul class='nav menu'>
			<li class='active'><a href='dashboard_ts.php'><svg class='glyph stroked dashboard-dial'><use xlink:href='#stroked-dashboard-dial'></use></svg> Dashboard</a></li>
    ...
    while($row=mysqli_fetch_assoc($query))
    {
        ...
        echo "<div class='col-xs-12 col-md-6 col-lg-3 cards' style='margin-right:20px; margin-bottom:20px;'>
				...
				<div class='container1'>
					<h4><b>Name&nbsp;<i class='fa fa-user' aria-hidden='true'></i></b> &nbsp;".$row['Name']."</h4> 
					<br>
